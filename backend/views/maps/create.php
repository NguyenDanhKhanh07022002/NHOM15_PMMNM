...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="hotline" value="<?php echo isset($_POST['hotline']) ? $_POST['hotline'] : '' ?>"
    ...
    <div class="form-group">
        ...
        <textarea name="map_url" id="map_url"
                  class="form-control"><?php echo isset($_POST['map_url']) ? $_POST['map_url'] : '' ?></textarea>
    </div>
    <div class="form-group">
