...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="weight"
               value="<?php echo isset($_POST['weight']) ? $_POST['weight'] : $product['weight']?>";
               class="form-control" id="weight"/>
    </div>
    <div class="form-group">
        <label for="supplier">Nhà cung cấp</label>
        <input type="text" name="supplier" value="<?php echo isset($_POST['supplier']) ? $_POST['supplier'] : $product['supplier']?>"
    ...
    <div class="form-group">
        ...
        if ($product['hot'] == 1)
            $checked_hot = 'checked';
        ?>
        <input type="checkbox" name="hot" value="1" <?php echo $checked_hot; ?>
               id="hot"/>
